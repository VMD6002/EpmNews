          ...
          {blogs.length !== 0 ? (
            ...
            <div className="h-screen grid place-items-center">
              <div className="grid bg-orange-100 py-2 px-3 rounded-lg">
                <span className="text-center">No News has been posted on the topic {data[filt]}</span>
                <Link href="/"><a className="text-center p-4 bg-orange-200 m-2">Go back to Main page</a></Link>
              </div>
            </div>
          )}
        </div>
